 ...
 *		        - Added uint32_t_MAX\n
 *		        - Removed inline functions: _min, _max, _ldmst, _getA11, _swap. Moved _minu to
 *driver.\n
 *		        - Adapted file to work on both, ARUIX and PSoC\n
 *		        - Added RC_t enums: RC_ERROR_BAD_PARAM, RC_ERROR_BAD_DATA, RC_ERROR_CANCELED,
 *RC_ERROR_INVALID_STATE, RC_UNKNOWN\n\n
 *
 * \copyright Copyright �2016
 * Department of electrical engineering and information technology, Hochschule Darmstadt -
 *University of applied sciences (h_da). All Rights Reserved. Permission to use, copy, modify, and
 *distribute this software and its documentation for educational, and research purposes in the
 *context of non-commercial (unless permitted by h_da) and official h_da projects, is hereby granted
 *for enrolled students of h_da, provided that the above copyright notice, this paragraph and the
 *following paragraph appear in all copies, modifications, and distributions. Contact Prof.Dr.-Ing.
 *Peter Fromm, peter.fromm@h-da.de, Birkenweg 8 64295 Darmstadt - GERMANY for commercial requests.
 *
 * \warning This software is a PROTOTYPE version and is not designed or intended for use in
 *production, especially not for safety-critical applications! The user represents and warrants that
 *it will NOT use or redistribute the Software for such purposes. This prototype is for research
...
enum eRC {
    ...
    RC_ERROR_NOT_MATCH =
        -19, /**< \brief Could not write to the object.								 	    */
    RC_ERROR_BAD_PARAM =
        -20, /**< \brief Parameters passed to the function are invalid or illegal.           */
    ...
    RC_ERROR_INVALID_STATE =
        -23, /**< \brief The operation can not be performed because of a FSM-state           */
    RC_ERROR_CLOSE = -24, /**< \brief The device could not be closed */
    RC_ERROR_MAILBOX_FAIL = -25,
    RC_ERROR_UNKNOWN = -26, /**< \brief Unknown error. */
};
