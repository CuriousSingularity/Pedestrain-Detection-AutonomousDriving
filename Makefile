...
PATH_OPENCV_INCLUDE=/opt/OpenCV/include/opencv4/
PATH_ALL_INCLUDE=$(IFLAGS)$(PATH_APP_INCLUDE) $(IFLAGS)$(PATH_OS_INCLUDE) $(IFLAGS)$(PATH_HAL_INCLUDE) $(IFLAGS)$(PATH_OPENCV_INCLUDE) $(IFLAGS)$(PATH_PROJECT)

exe:obj
	$(CC) $(EFLAGS) exe_$(PLATFORM) -L/opt/OpenCV/lib/ $(LFLAGS) $(PATH_BUILD_DIR)/*.o	\
