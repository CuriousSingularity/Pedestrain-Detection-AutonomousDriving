...
CC=g++
CFLAGS=-c -Wall
LFLAGS=-pthread -lopencv_imgproc -lopencv_core -lopencv_highgui -lopencv_calib3d -lopencv_objdetect -lopencv_flann 
EFLAGS=-o
DFLAGS=-D
IFLAGS=-I

PATH_OPENCV_INCLUDE=$(IFLAGS)/usr/include/opencv2/ $(IFLAGS)/usr/include/opencv/
PATH_ALL_INCLUDE=$(IFLAGS)$(PATH_APP_INCLUDE) $(IFLAGS)$(PATH_OS_INCLUDE) $(IFLAGS)$(PATH_HAL_INCLUDE)

exe:obj
	$(CC) $(EFLAGS) exe_$(PLATFORM) $(PATH_ALL_INCLUDE) $(LFLAGS) $(PATH_BUILD_DIR)/*.o	\
