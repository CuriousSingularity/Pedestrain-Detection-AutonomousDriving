...
global::RC_t ConfigurationManager::setValue(ConfigCategory category, const string& key,
...
ConfigValue ConfigurationManager::getValue(ConfigCategory category, const string& key,
...
string ConfigurationManager::categoryToString(ConfigCategory category) const {
    switch (category) {
    case ConfigCategory::DETECTION:
        return "DETECTION";
    case ConfigCategory::CAMERA:
        return "CAMERA";
    case ConfigCategory::COMMUNICATION:
        return "COMMUNICATION";
    case ConfigCategory::SYSTEM:
        return "SYSTEM";
    case ConfigCategory::LOGGING:
        return "LOGGING";
    default:
        return "UNKNOWN";
    }
...
ConfigCategory ConfigurationManager::stringToCategory(const string& categoryStr) const {
    ...
    if (upperStr == "DETECTION")
        return ConfigCategory::DETECTION;
    if (upperStr == "CAMERA")
        return ConfigCategory::CAMERA;
    if (upperStr == "COMMUNICATION")
        return ConfigCategory::COMMUNICATION;
    if (upperStr == "SYSTEM")
